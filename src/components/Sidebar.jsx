...
function Sidebar() {
  return (
    <div className="sidebar">
      ...
      <span className="h1">Kanini</span>
      <br />
      <span className="px-5 ms-5">Assessment</span>

      <ul className="list-group list-group-flush">
        <li className="nav-item my-2 px-3 py-2">
          <i className="bi bi-intersect fs-5 me-2"></i>
          <span>Dashboard</span>
        </li>
        <li className="nav-item  list-group-item my-2 py-2 px-2">
          <i className="bi bi-journal fs-4 me-2"></i>
          <span>Questions</span>
        </li>
        <li className="nav-item list-group-item  px-2 my-2 py-2">
          <i className="bi bi-bag fs-4 me-2"></i>
          <span>Jobseeker</span>
        </li>
        <li className="nav-item list-group-item px-2 my-2 py-3">
          <i className="bi bi-person-vcard-fill me-3"></i>
          <span>Employee</span>
        </li>
        <li className="nav-item list-group-item px-2  my-2">
